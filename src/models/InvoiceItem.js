...
export class InvoiceItem {
  constructor({ description = '', qty = 1, unitPrice = 0, taxRate = 0.15, discount = 0, code = '', unit = '' } = {}) {
  ...
  toJSON() {
    return { description: this.description, code: this.code, unit: this.unit, qty: this.qty,
      unitPrice: this.unitPrice, taxRate: this.taxRate, discount: this.discount };
  }
